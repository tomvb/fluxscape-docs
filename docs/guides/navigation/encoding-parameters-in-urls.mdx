...
<ImportButton
    zip="/docs/guides/navigation/encoding-parameters-in-urls/param-encoding-url.zip"
    name="Encoding Parameters in URL"
    thumb="/docs/guides/navigation/encoding-parameters-in-urls/show-products-page-4.png"
/>
